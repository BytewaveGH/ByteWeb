...
export function GithubIcon({ className, ...rest }: { className: string }) {
  (
    <svg
...
// #0A66C2
export function LinkedInIcon({ className, ...rest }: { className: string }) {
  (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="1em"
...
export function PinterestIcon({ className, ...rest }: { className: string }) {
  (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="1em"
...
export function DribbbleIcon({ className, ...rest }: { className: string }) {
  (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="1em"
...
export function SunIcon({ className, ...rest }: { className: string }) {
  (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="24"
...
export function MoonIcon({ className, ...rest }: { className: string }) {
  (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="24"
...
export function CircularText({ className, ...rest }: { className: string }) {
  (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="496"
