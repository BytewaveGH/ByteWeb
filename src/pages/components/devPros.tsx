...
import agilepro from '../../../public/agilepro.jpg';
import agilesteps from '../../../public/agilesteps.webp';
import Image from 'next/image';


export default function DevPros() {
  return (
    <div>
      {/* <!-- Features --> */}
      <div className="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
        <div className="aspect-w-16 aspect-h-7">
          {/* <img className="w-full object-cover rounded-xl" src={tryx} alt="Image Description" /> */}
          {/* <Image src={agilepro}  alt='' className=" rounded-xl" /> */}
          <Image src={agilesteps} alt='' className="w-full  rounded-xl" />
            ...
            <div className="grid sm:grid-cols-2 gap-8 md:gap-12">
              ...
              <div className="flex gap-x-5">
                ...
                <div className="grow">
                  ...
                  <p className="mt-1 text-gray-600 dark:text-gray-400">
                    From single page applications to ERP systems, there is really no dream that cannot to achieved with Bytewave.
                  </p>
                </div>
              </div>
              {/* <!-- End Icon Block --> */}
