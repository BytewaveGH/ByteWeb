  ...
  return (
    <div className="overflow-hidden bg-white py-16 sm:py-16">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        {imageRight ? (
            <div className="w-full flex justify-between  sm:gap-y-20 lg:mx-0 lg:max-w-none ">
          <div className="lg:pr-8 lg:pt-4">
           ...
           <Image src={laptop } alt="" width={650} height={300} />
        </div>
        ) : (
            <div className=" flex justify-between sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2">
                <Image src={laptop } alt="" width={650} height={300} />
          <div className="lg:pr-8 lg:pt-4">
